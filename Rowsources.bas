...
' If there are no filters then the list is empty.
   ...
   If Not filters("J‰rjestelm‰") = "" Then
       where = where & " AND J‰rjestelm‰ Like '" & filters("J‰rjestelm‰") & "'"
   End If
   ...
   If Not filters("Tuoteryhm‰") = "" Then
       where = where & " AND Tuoteryhm‰ Like '" & filters("Tuoteryhm‰") & "'"
   End If
   
   If Not filters("TRnimi") = "" Then
       where = where & " AND [Tuoteryhm‰n nimi] Like '" & filters("TRnimi") & "'"
   End If
   
   If Not filters("K‰yttˆluokka") = "" Then
       where = where & " AND K‰yttˆluokka Like '" & filters("K‰yttˆluokka") & "'"
   End If
